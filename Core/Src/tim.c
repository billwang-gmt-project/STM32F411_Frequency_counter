...
void MX_TIM2_Init(void)
{
  ...
  if (HAL_TIM_IC_ConfigChannel(&htim2, &sConfigIC2, TIM_CHANNEL_2) != HAL_OK)
  {
    Error_Handler();
  }
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE BEGIN TIM2_MspInit 1 */
    /* Override CubeMX: remap TIM2_CH1 from PA0 to PA15 */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_0);
    GPIO_InitTypeDef GPIO_InitOverride = {0};
    GPIO_InitOverride.Pin = GPIO_PIN_15;
    GPIO_InitOverride.Mode = GPIO_MODE_AF_PP;
    GPIO_InitOverride.Pull = GPIO_NOPULL;
    GPIO_InitOverride.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitOverride.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(GPIOA, &GPIO_InitOverride);
